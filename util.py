...
def write_csv_data(data: list) -> None:
    header = ["title", "date", "description", "image", "is_title_dolar", "is_description_dolar", "phrase_count"]
    lib = Files()
    lib.create_workbook()
    lib.set_cell_value(1, "A", "Title")
    lib.set_cell_value(1, "B", "Date")
    lib.set_cell_value(1, "C", "Description")
    lib.set_cell_value(1, "D", "image")
    lib.set_cell_value(1, "E", "is_title_dolar")
    lib.set_cell_value(1, "F", "is_description_dolar")
    lib.set_cell_value(1, "G", "phrase_count")
    lib.append_rows_to_worksheet(data)
    lib.save_workbook("news_output.xlsx")
